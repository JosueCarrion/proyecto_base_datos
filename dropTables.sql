...
DROP FUNCTION IF EXISTS actualizar_tarifa_llamada;
DROP FUNCTION IF EXISTS actualizar_tarifa_celular;
DROP TRIGGER IF EXISTS trg_actualizar_fechas_contrato ON Contrato;
DROP TRIGGER IF EXISTS trg_actualizar_tarifa_llamada ON Llamada;
DROP TRIGGER IF EXISTS trg_actualizar_tarifa_celular ON Celular;